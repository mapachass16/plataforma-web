...
insert into saas.tenants (id, name, slug)
...
select is(
               (select created_by from saas.tenants where id = '00000000-0000-0000-0000-000000000000'),
               tests.get_supabase_uid('test1'),
               'created_by is set to the user that created the tenant'
           );
select is(
               (select updated_by from saas.tenants where id = '00000000-0000-0000-0000-000000000000'),
               tests.get_supabase_uid('test1'),
               'created_by is set to the user that created the tenant'
           );

--- test updating tenants
...
select is(
               (select updated_by from saas.tenants where id = '00000000-0000-0000-0000-000000000001'),
               NULL,
...
select update_tenant('00000000-0000-0000-0000-000000000000', slug => 'updated-slug');

select is(
               (select updated_by from saas.tenants where id = '00000000-0000-0000-0000-000000000000'),
               tests.get_supabase_uid('test_member'),
               'updated_by is set to the user that updated the tenant'
           );
